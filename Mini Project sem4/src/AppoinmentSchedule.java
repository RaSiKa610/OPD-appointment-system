    ...
    class AppointmentSchedule extends JFrame {
        AppointmentSchedule(String username) {
            ...
            JLabel title = new JLabel("Appointments Schedule", JLabel.CENTER);
            ...
            JDateChooser PatientDateFilter = new JDateChooser();
            PatientDateFilter.setDateFormatString("yyyy-MM-dd");
            ...
            filterPanel1.setBackground(new Color(224, 224, 224));
            filterPanel1.add(new JLabel("Date:"));
            filterPanel1.add(PatientDateFilter);
            filterPanel1.add(b3);
                    ...
                    a -> {
                        ...
                        try (Connection con = DriverManager.getConnection(url, "root", "Shlok2401@")) {
                            ...
                            try (PreparedStatement pst = con.prepareStatement(sql)) {
                                ...
                                String selectSQL = "SELECT * FROM appointments WHERE doctor_name = ?";
                                try (PreparedStatement selectPst = con.prepareStatement(selectSQL)) {
                                    ...
                                    while (rs.next()) {
                                        ...
                                        String appointment_date = rs.getString("available_date_to");
                                        String appointment_time = rs.getString("available_start_time");

                                        tableModel.addRow(new Object[]{doctorName, patient_name, appointment_date, appointment_time});
                                    }
                                }
                            }
                        } catch (Exception e) {
        ...
        public static void main(String[] args) {
            new AppointmentSchedule("Rasika");
        }
    }